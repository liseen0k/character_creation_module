...
def special(char_name: str, char_class: str) -> str:
    """Отвечает за специальные умения классов."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Отвечает за выбор класса персонажа."""
    ...
    while approve_choice != 'y':
        ...
        print('Маг — mage, ')
        char_class = input('Лекарь — healer: ')
        if char_class == 'warrior':
